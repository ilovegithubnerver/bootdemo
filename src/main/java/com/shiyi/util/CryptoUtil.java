...
public class CryptoUtil {
	...
	public static void main(String[] args) {
		try {
			//PublicKey publicKey = CryptoUtil.getPublicKey(new FileInputStream("D:/rsa_public_key_2048.pem"), "RSA");
			//PrivateKey privateKey = CryptoUtil.getPrivateKey(new FileInputStream("D:/pkcs8_rsa_private_key_2048.pem"), "RSA");
            //
			//String plainXML = "1234";
